...
<div class="details row">
    <?php foreach ($tithes as $tithe): ?>
        ...
        <div class="column_details col-md-8"><?php echo h(date('d/m/Y',strtotime($tithe[0]['created']))); ?>&nbsp;</div>
        <div class="column_details col-md-4"><?php echo h($tithe[0]['value']); ?>&nbsp;</div>

    <?php  endforeach;?>
        <div class="column_summary number col-md-12">Total: R$ <?php echo $total; ?>&nbsp;</div>
</div>
